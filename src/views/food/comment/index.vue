  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="commentRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="美食ID" prop="foodId">
          <el-input v-model="form.foodId" placeholder="请输入美食ID" />
        </el-form-item>
        <el-form-item label="评论内容" prop="content">
...
import { listComment, getComment, delComment, addComment, updateComment } from "@/api/food/comment";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除美食评论编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('food/comment/export', {
    ...queryParams.value
